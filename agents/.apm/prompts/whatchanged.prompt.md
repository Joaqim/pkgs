---
description: List features added to anylang-template during a timeframe
argument-hint: "<timeframe> (e.g. 'last week', 'last 2 weeks', 'since 2026-03-01')"
---

List features added to anylang-template during: $ARGUMENTS (e.g. "last week", "last 2 weeks", "since 2026-03-01")
...
```
## What changed in anylang-template ($ARGUMENTS)
